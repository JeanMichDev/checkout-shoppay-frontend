...
function App() {
  return (
    <body className=" lg:overflow-y-scroll">
      <main className="mx-auto flex max-w-screen-xl flex-col items-center justify-center lg:flex-row lg:items-start lg:justify-center lg:gap-0 ">
        <div className="flex flex-col items-center justify-start gap-2  lg:flex-[3] lg:gap-6 lg:py-5">
          ...
          <AccordionPhoneNumer className="lg:pl-20 lg:pr-10" />
