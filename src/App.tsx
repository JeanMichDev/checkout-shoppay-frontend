...
function App() {
  return (
    <div className="min-h-full bg-blue-100/90">
      <main className="m-auto flex max-w-screen-lg flex-col items-center justify-center bg-background lg:max-w-screen-xl lg:flex-row lg:items-start lg:justify-center">
